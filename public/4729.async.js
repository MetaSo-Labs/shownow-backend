"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[4729],{
...
// EXTERNAL MODULE: ./node_modules/.pnpm/@ant-design+icons@5.5.1_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@ant-design/icons/es/icons/DoubleLeftOutlined.js + 1 modules
var DoubleLeftOutlined = __webpack_require__(66196);
// EXTERNAL MODULE: ./node_modules/.pnpm/@ant-design+icons@5.5.1_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/@ant-design/icons/es/icons/DoubleRightOutlined.js + 1 modules
var DoubleRightOutlined = __webpack_require__(13033);
...
// EXTERNAL MODULE: ./node_modules/.pnpm/rc-pagination@4.3.0_react-dom@18.3.1_react@18.3.1__react@18.3.1/node_modules/rc-pagination/es/index.js + 3 modules
var es = __webpack_require__(17447);
  ...
  return {
    [listBorderedCls]: {
      ...
      [`${componentCls}-pagination`]: {
        margin: `${(0,cssinjs_es.unit)(margin)} ${(0,cssinjs_es.unit)(marginLG)}`
      }
    },
    ...
    [`@media screen and (max-width: ${screenSM}px)`]: {
      ...
      [`${componentCls}-vertical`]: {
        [`${componentCls}-item`]: {
          ...
          [`${componentCls}-item-extra`]: {
            margin: `auto auto ${(0,cssinjs_es.unit)(margin)}`
          }
        }
      }
    }
...
const genBaseStyle = token => {
  ...
  return {
    [componentCls]: Object.assign(Object.assign({}, (0,es_style/* resetComponent */.Wf)(token)), {
      ...
      [`${componentCls}-item`]: {
        ...
        [`${componentCls}-item-meta`]: {
          ...
          [`${componentCls}-item-meta-title`]: {
            margin: `0 0 ${(0,cssinjs_es.unit)(token.marginXXS)} 0`,
            color: colorText,
      ...
      [`${componentCls}-empty`]: {
        padding: `${(0,cssinjs_es.unit)(padding)} 0`,
        color: colorTextDescription,
        fontSize: token.fontSizeSM,
        textAlign: 'center'
      },
    ...
    [`${componentCls}-vertical ${componentCls}-item`]: {
      ...
      [`${componentCls}-item-action`]: {
        ...
        '> li': {
          padding: `0 ${(0,cssinjs_es.unit)(padding)}`,
          '&:first-child': {
            paddingInlineStart: 0
          }
        }
    ...
    [`${componentCls}-split ${componentCls}-item`]: {
      borderBlockEnd: `${(0,cssinjs_es.unit)(token.lineWidth)} ${token.lineType} ${token.colorSplit}`,
      '&:last-child': {
        borderBlockEnd: 'none'
      }
    },
    ...
    [`${componentCls}-split${componentCls}-empty ${componentCls}-footer`]: {
      borderTop: `${(0,cssinjs_es.unit)(token.lineWidth)} ${token.lineType} ${token.colorSplit}`
    },
...
const style_prepareComponentToken = token => ({
  contentWidth: 220,
  itemPadding: `${(0,cssinjs_es.unit)(token.paddingContentVertical)} 0`,
  itemPaddingSM: `${(0,cssinjs_es.unit)(token.paddingContentVerticalSM)} ${(0,cssinjs_es.unit)(token.paddingContentHorizontal)}`,
  itemPaddingLG: `${(0,cssinjs_es.unit)(token.paddingContentVerticalLG)} ${(0,cssinjs_es.unit)(token.paddingContentHorizontalLG)}`,
...
/* harmony default export */ var list_style = ((0,genStyleUtils/* genStyleHooks */.I$)('List', token => {
  ...
  return [genBaseStyle(listToken), style_genBorderedStyle(listToken), genResponsiveStyle(listToken)];
