"use strict";
(self["webpackChunk"] = self["webpackChunk"] || []).push([[4803],{
...
;// CONCATENATED MODULE: ./src/hooks/useKeepAlive.tsx



var _excluded = (/* unused pure expression or super */ null && (["keepalive"]));
...
var KeepAliveContext = /*#__PURE__*/(0,react.createContext)({
  keepalive: ['/', '/home', '/follow', '/profile'],
  keepElements: {}
});
var isKeepPath = function isKeepPath(aliveList, path) {
  var isKeep = false;
  aliveList.map(function (item) {
    if (item === path) {
      isKeep = true;
    }
...
function useKeepOutlets() {
  ...
  var isKeep = isKeepPath(keepalive, location.pathname);
  if (isKeep) {
    keepElements[location.pathname] = element;
  }
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [Object.entries(keepElements).map(function (_ref) {
      ...
      return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        ...
        hidden: !(0,_umi_production_exports.matchPath)(location.pathname, pathname),
        children: element
      }, pathname);
    }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      hidden: isKeep,
      ...
      children: !isKeep && element
    })]
  });
}
var KeepAliveLayout = function KeepAliveLayout(props) {
  var keepalive = props.keepalive,
    other = _objectWithoutProperties(props, _excluded);
  var keepElements = React.useRef({});
  function dropByCacheKey(path) {
    keepElements.current[path] = null;
  }
  return /*#__PURE__*/_jsx(KeepAliveContext.Provider, _objectSpread({
    value: {
      keepalive: keepalive,
...
/* harmony default export */ var useKeepAlive = ((/* unused pure expression or super */ null && (KeepAliveLayout)));
